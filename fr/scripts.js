function buildbr() {
 ...
 { alert("Le contenu du code est vide!");
  return;}
      ...
      if (document.getElementById("qcode").style.paddingBottom=="5px")
       {
        ...
        document.getElementById("howto").setAttribute("src","UseBRcode.html"); 
      }
     }
     function switchqr(){
      if(document.getElementById("bcode").style.paddingBottom=="5px")
      {
        ...
        document.getElementById("howto").setAttribute("src","UseQRcode.html"); 
